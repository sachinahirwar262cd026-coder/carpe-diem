...
## 🔌 Connecting to the Air Pollution ML Service
- **Base URL:** `http://localhost:8000`
- **Forecast Endpoint:** `POST /api/forecast`
...
1. **Air Quality Intelligence & Forecasting (`/air-quality`)**
   - Live CPCB Ground Truth + OpenWeather / Open-Meteo API telemetry data fusion.
   - 24-Hour hourly micro-pocket AQI predictions with confidence bounds powered by **Bi-LSTM**.
...
└── src/
    ...
    ├── data/            # Data fusion & research mock datasets
